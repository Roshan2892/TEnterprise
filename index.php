                                        ...
                                        <div class='col-md-6'>
                                            <div class='portfolio-item'> 
                                                <a class='thumbnail' href='#' data-image-id="<?php echo $row['image_id'] ?>" data-toggle='modal' 
                                                    ...
                                                    data-image="<?php echo $value ?>" data-target='#image-gallery'> 
                                                        <img class='img-responsive img-portfolio' width"400px" height="100px" src='<?php echo $value ?>'  alt='Short alt text'>
                                                </a>
                                            </div>
                                        </div>
                        <?php
                                            ...
                                            <div class='col-md-6'>
                                                <div class='portfolio-item'> 
                                                    <a class='thumbnail' href='#' data-image-id="<?php echo $row['image_id'] ?>" data-toggle='modal' 
                                                        data-title="<?php echo $row['image_title'] ?>" data-caption="<?php echo $row['description'] ?>" 
                                                        data-image="<?php echo $value ?>" data-target='#image-gallery'> 
                                                            <img class='img-responsive img-portfolio' src="<?php echo $value ?>" alt='Short alt text'>
                                                    </a>
                                                </div>
                                            </div>
                                        </div> 
